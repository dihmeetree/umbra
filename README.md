<p align="center">
  <img src="assets/umbra-header.jpg?v=4" alt="Umbra" width="850">
</p>
...
**~35,000 lines of Rust** across 45 source files with **1099 tests**.
...
```bash
cargo test                       # Full suite (~1099 tests)

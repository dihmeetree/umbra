...
Umbra is a post-quantum private cryptocurrency with DAG-BFT consensus, written in Rust. ~35k lines across 45 source files with 1165 tests. Single crate, no workspace.
...
cargo test --features fast-tests # Fast suite (~1165 tests, ~1.5 min)

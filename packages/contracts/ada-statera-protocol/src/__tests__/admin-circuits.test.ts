...
describe('Ada Statera Protocol - Admin Circuits', () => {
  ...
  describe('Oracle Management', () => {
    ...
    it('should remove trusted oracle', () => {
      ...
      expect(() => {
        simulator
          .as(adminState)
          .executeImpureCircuit('removeTrustedOraclePk', oraclePk)
      }).not.toThrow()
    })
    ...
    it('should add multiple oracles', () => {
      ...
      expect(() => {
        simulator
          .as(adminState)
          .executeImpureCircuit('addTrustedOracle', oracle1)
        simulator
          .as(adminState)
          .executeImpureCircuit('addTrustedOracle', oracle2)
        simulator
          .as(adminState)
          .executeImpureCircuit('addTrustedOracle', oracle3)
      }).not.toThrow()
    })
  })
  ...
  describe('Admin Management', () => {
    ...
    it('should remove admin', () => {
      ...
      expect(() => {
        simulator
          .as(updatedAdminState)
          .executeImpureCircuit('removeAdmin', adminToRemove)
      }).not.toThrow()
    })

...
describe('Ada Statera Protocol - Basic Tests', () => {
  ...
  describe('Balance Tracking', () => {
    ...
    it('should track multiple tokens per wallet', () => {
      const { balanceTracker, adminWallet, sSUSDTokenType, sADATokenType } =
        fixture
      ...
      const sSUSDBalance = balanceTracker.getBalance(
        adminWallet.coinPublicKey,
        sSUSDTokenType
      )
      const sADABalance = balanceTracker.getBalance(
        adminWallet.coinPublicKey,
        sADATokenType
      )

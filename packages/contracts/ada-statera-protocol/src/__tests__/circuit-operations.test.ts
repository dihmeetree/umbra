...
describe('Ada Statera Protocol - Circuit Operations', () => {
  ...
  describe('Balance Queries', () => {
    it('should return zero balance for non-existent tokens', () => {
      ...
      const balance = simulator.getBalance(adminWallet.coinPublicKey, sSUSDTokenType);
  ...
  describe('Balance Tracker Integration', () => {
    ...
    it('should track balance changes', () => {
      ...
      const initialBalances = balanceTracker.getAllBalances(adminWallet.coinPublicKey);

      // Update balance
      balanceTracker.setBalance(adminWallet.coinPublicKey, sSUSDTokenType, 1500n);
  ...
  describe('Multi-User Operations', () => {
    ...
    it('should maintain separate balances per user', () => {
      ...
      userWallets.forEach((wallet, index) => {
        const balance = balanceTracker.getBalance(wallet.coinPublicKey, sSUSDTokenType);
